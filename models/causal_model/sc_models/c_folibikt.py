...
class cFoLiBiKT(folibiKT):
    def __init__(self, n_question, n_pid, d_model, n_blocks, dropout, d_ff=256,
        ...
        super().__init__(n_question, n_pid, d_model, n_blocks, dropout, d_ff, kq_same, final_fc_dim, num_attn_heads, separate_qa, l2, seq_len, emb_type, emb_path, pretrain_dim, num_buckets, max_distance)
        self.model_name = "cfolibikt"
