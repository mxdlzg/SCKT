...
def main(params):
    ...
    with open("../../configs/kt_config.json") as f:
        ...
        if model_name in ["dkvmn", "deep_irt", "sakt", "saint", "saint++", "akt", "cakt", "folibikt", "atkt", "lpkt", "skvmn",
                          "dimkt"]:
    ...
    if model_name in ["saint", "saint++", "sakt", "atdkt", "simplekt", "csimplekt", "stablekt", "cstablekt", "bakt_time", "folibikt"]:
